...
if @item_amount.persisted?
  json.form render(partial: 'items/item_amounts_show', formats: :html, locals: { item_amount: @item_amount })
  json.inserted_item render(partial: 'new_item_amount_form', formats: :html, locals: { item: @item, item_amount: ItemAmount.new })
else
  json.form render(partial: 'new_item_amount_form', formats: :html, locals: { item: @item, item_amount: @item_amount })
end
